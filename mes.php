                ...
                <div class="box-body">
                  <div class="row">
                    ...
                    <tbody><tr>
                      <th>Médico</th>
                      <th>2ª à 5ª</th>
                      <th>Fim de semana<br />(sex;sab;dom)</th>
                      <th>Apoio</th>
                 ...
                 $result = mysqli_query($conn,$sql);
                  while($row = mysqli_fetch_array($result))
                  {
                      ...
                      $meio_semana = 700 * $meio_semana;
                      $meio_fds = 750 * $meio_fds;
                      $meio_apoio = 750 * $meio_apoio;
                      $semana =1400 * $semana + $meio_semana;
                      $fds = 1500 * $fds + $meio_fds;
                      $apoio = 1500 * $apoio + $meio_apoio;
                      $soma = $semana + $fds + $apoio;
                      echo "<tr><td><a href='http://192.168.0.4/plantao/med.php?id=".$row['CRM']."'>".$row['Nome']."</a></td><td>R$".$semana.",00</td><td>R$".$fds.",00</td><td>R$".$apoio.",00</td><td>R$".$soma.",00</td></tr>";
                  }   
                   ?>
